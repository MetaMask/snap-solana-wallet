...
export const ADDRESS_2_TRANSACTION_2_DATA: SolanaTransaction = {
  ...
  meta: {
    ...
    postBalances: [2883830040n, 7400935000n, 1n, 1n] as Lamports[],
    postTokenBalances: [],
    preBalances: [2983835040n, 7300935000n, 1n, 1n] as Lamports[],
    preTokenBalances: [],
    rewards: [],
    status: { Ok: null },
  },
  slot: 353870020n as Slot,
  transaction: {
    message: {
      accountKeys: [
      ...
      recentBlockhash:
        'H3UXVntFNsvkEPxoMpZhN23SXvn8TstXCmexPrt4YcJt' as Blockhash,
    },
    signatures: ['signature-6'] as Base58EncodedBytes[],
  },
  version: 0,
};
