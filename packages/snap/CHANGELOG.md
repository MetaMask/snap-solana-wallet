...
- Refactor and changed swap/bridge `onClientRequest` methods ([#496](https://github.com/MetaMask/snap-solana-wallet/pull/496))
...
[Unreleased]: https://github.com/MetaMask/snap-solana-wallet/compare/v2.3.0...HEAD
